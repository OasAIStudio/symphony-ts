...
7. Open a PR targeting this repo (not its upstream fork parent) via `gh pr create --repo $(gh repo view --json nameWithOwner -q .nameWithOwner)` with the issue description in the PR body.
